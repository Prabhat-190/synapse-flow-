"""CLI entry point for SynapseFlow orchestrator."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SynapseFlow Multi-Agent Orchestrator")
...
def _serve() -> None:
    ...
    uvicorn.run("synapse.gateway.app:app", host="0.0.0.0", port=8000, reload=True)
