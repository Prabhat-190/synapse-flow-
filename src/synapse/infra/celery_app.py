...
celery_app.conf.update(
    ...
    task_routes={"synapse.tasks.*": {"queue": "synapse.default"}},
    worker_prefetch_multiplier=1,
)


@celery_app.task(name="synapse.tasks.run_pipeline", bind=True, max_retries=2)
...
@celery_app.task(name="synapse.tasks.run_eval")
